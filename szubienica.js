...
function sprawdz(nr) {
    ...
    if (count_fail >= 9) {
        document.getElementById("alphabet").innerHTML = "You lose,<br /><br /> The correct password is: " + password + '<br /><br /><span class="reset" onclick="location.reload()" style="background-color:#801010; color:#330000;">Click if you want one more time?</span>'
    ...
    if (password == password1) {
        document.getElementById("alphabet").innerHTML = "You Won ;)" + '<br /><br /><span class="reset" onclick="location.reload()" style="background-color:#265c06; color:#003300;">Click if you want one more time?</span>'
